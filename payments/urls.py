...
urlpatterns = [
    ...
    path("change-orders/<int:pk>/pay/initialize", views.initialize_change_order_payment),
    ...
    path("projects/<int:pk>/refunds", views.project_refunds),
    path("refunds/<int:pk>/decide", views.decide_refund),
    path("refunds/queue", views.refund_queue),
